...
const ngrokUrl = 'https://2e8e-23-106-140-196.ngrok-free.app';
...
app.use('/api/business-rules/expression_variables', async (req, res) => {
    try {
        ...
        res.json({
            "rmbAmount": {
                "name": "折人民币金额",
                "description": "将原价按人民币汇率换算的金额",
                "beIncludedSubsidy": false,
                "beAnnualized": false,
                "beFirstYear": false,
                "beFullLife": false,
                "type": "AMOUNT"
            ...
            "benchmarkInterestRate": {
                "name": "基准利率",
                "description": "商业银行存款、贷款、贴现等业务的指导性利率",
                "beIncludedSubsidy": false,
                "beAnnualized": true,
                "beFirstYear": false,
                "beFullLife": false,
